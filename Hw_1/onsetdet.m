function [pos,V0] = onsetdet(f,win_length,thre,range,multi,shift,showplot,timeNorm)
...
tgap = win_length/16; %8
%ODF'ýn size'ý, plot'taki x eksenini temsil ediyor diye düþün
...
if showplot ~= 0    % Plot the results
    ...
    vline(pos2,'k'); %Uzun (ilk spectrogram'daki) siyah çizgileri çiziyor
    subplot(1,2,2);
   ...
   sss = pos'
    ...
    %}  
   jjjj = pos2';
    realVals = jjjj ./ length(ODF) * timeNorm
